...
@Component
public class Right_A_Processor implements Processor {
    ...
    @Autowired
    public Right_A_Processor(ButtonProvider buttonProvider, PathProvider pathProvider, PathRegistry pathRegistry) {
