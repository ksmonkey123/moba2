...
@Component
public class Right_B_Controller implements Controller {
    ...
    public Right_B_Controller(ButtonProvider buttonProvider, PathProvider pathProvider, PathRegistry pathRegistry) {
